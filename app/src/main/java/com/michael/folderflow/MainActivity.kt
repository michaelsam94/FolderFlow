...
import com.michael.folderflow.core.presentation.ViewModelFactory
...
import com.michael.folderflow.feature.organizer.presentation.AppDetailRoute
            ...
            composable("organizer") {
                AppOrganizerScreen(
                    ...
                    onOpenAppDetails = { packageName ->
                        navController.navigate("app_detail/${Uri.encode(packageName)}")
                    }
                )
            }
